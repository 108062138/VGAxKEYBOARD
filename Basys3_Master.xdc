...
set_property IOSTANDARD LVCMOS33 [get_ports singleChannel]
set_property PACKAGE_PIN V17 [get_ports singleChannel]
set_property PACKAGE_PIN V16 [get_ports adjVol]
set_property IOSTANDARD LVCMOS33 [get_ports adjVol]
